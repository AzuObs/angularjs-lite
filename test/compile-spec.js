  ...
  describe("$compile", function() {
    ...
    _.forEach(["x", "data"], function(prefix) {
      _.forEach([":", "-", "_"], function(delim) {
        // ALL OF THESE ARE ACCEPTABLE WAYS OF WRITING NG DIRECTIVES
        // <x:my-directive></x:my-directive>
        // <x_my-directive></x_my-directive>
        // <x-my-directive></x-my-directive>
        // <data-my-directive></data-my-directive>
        // loop through each to test each permutation
    ...
    // testing directiveObject.restrict
    _.forEach({
      E: {
        element: true,
        attribute: false,
      ...
      describe('restricted to ' + restrict, function() {
        ...
        _.forEach({
          ...
          }); // end it("element matches on <my-directive></my-directive>")
        }); // end forEach
